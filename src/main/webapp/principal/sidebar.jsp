			...
			<div class="main-menu-content">
				<ul>
					<li class="more-details"><a href="user-profile.html"><i
						...
						href="<%=request.getContextPath()%>/LoginServlet?acao=logout"><i
		...
		<ul class="pcoded-item pcoded-left-item">
			...
			<li class="pcoded-hasmenu"><a href="javascript:void(0)"
				...
				<ul class="pcoded-submenu">
					<c:if test="${perfil == 'ADMINISTRADOR' || perfil == 'DIRETOR'}">
						<li class=" "><a
							href="<%=request.getContextPath()%>/ServletCadastrarUsuario?acao=listarUser"
							class="waves-effect waves-dark"> <span class="pcoded-micon"><i
									class="ti-angle-right"></i></span> <span class="pcoded-mtext"
								data-i18n="nav.basic-components.alert">Cadastrar Usuario</span>
